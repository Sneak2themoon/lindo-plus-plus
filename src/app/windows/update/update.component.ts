    ...
    private applyRegex() {
        ...
        for (const filename in regex) {
            ...
            if (this.dofusMissingFiles[filename]) {
                ...
                if(filename == "build/script.js"){//ajout singleton "a la main"
                    this.dofusMissingFiles[filename] = (this.dofusMissingFiles[filename] as string).replace(new RegExp("return t\\.m = e, t\\.c = i, t\\.p = \"\", t\\(0\\)", 'g'), "window.singletons = t;\nreturn t.m = e, t.c = i, t.p = \"\", t(0)");
                }
